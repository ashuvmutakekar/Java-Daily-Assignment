...
public class StudentTester_TM {
 public static void main(String[] args) {
	 Scanner sc=new Scanner(System.in);
	  Map<StudentKey,Student> map=new TreeMap<>();
	  int ch;
	  do {
		  ...
		  case 1:{
			  ...
			  StudentKey key = a.getKey(); // Retrieve the key from the student object
		        map.put(key, a); // Store the student object in the TreeMap with its key
